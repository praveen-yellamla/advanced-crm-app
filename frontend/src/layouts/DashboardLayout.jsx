...
const DashboardLayout = () => {
  ...
  const menuItems = {
    ...
    MANAGER: [
      ...
      { name: 'Team Intelligence', icon: Target, path: '/manager/team-leads' },
      { name: 'Quality Control', icon: ShieldCheck, path: '/manager/qcqa' },
      { name: 'Workforce', icon: Users, path: '/manager/agents' },
    ...
    AGENT: [
      ...
      { id: 'dialer', name: 'Dialer', icon: Phone, path: '/agent/dialer' },
      { id: 'inbox', name: 'Inbox', icon: Mail, path: '/agent/inbox' },
      { id: 'history', name: 'Call History', icon: History, path: '/agent/history' },
